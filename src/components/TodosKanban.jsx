...
export default function TodosKanban({ contacts, tags, onTodoChange }) {
                    ...
                    {contactPending.map(todo => (
                      <div key={todo.id} style={{ background: 'var(--surface)', border: '0.5px solid var(--border)', borderRadius: 8, padding: '7px 9px', marginBottom: 5, display: 'flex', alignItems: 'flex-start', gap: 7 }}>
                        <button
                          ...
                          style={{ width: 14, height: 14, borderRadius: 3, border: '1.5px solid var(--border-strong)', background: 'transparent', cursor: 'pointer', flexShrink: 0, marginTop: 1, padding: 0 }}
                        />
